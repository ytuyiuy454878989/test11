...
install_custom_feed() {
    ...
    local base_custom_feed_packages=(
        ...
        msd_lite luci-app-msd_lite cups luci-app-cupsd openlist2 luci-app-openlist2 \
        luci-app-xunlei linkease luci-app-linkease
    ...
    local required_feed_dirs=(
        ...
        open-app-filter luci-app-oaf lucky luci-app-lucky luci-app-easytier openlist2 luci-app-openlist2
        luci-app-xunlei linkease luci-app-linkease
